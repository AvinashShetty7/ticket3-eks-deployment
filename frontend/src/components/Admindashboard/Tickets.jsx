      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 sm:mb-12">
          ...
          <p className="text-slate-600 text-sm sm:text-base text-center sm:text-left">
            View, filter, and assign support tickets to technicians
          </p>
        </div>
            ...
            {filteredTickets.map((ticket) => (
              ...
              >
                ...
                <div className="space-y-2 sm:space-y-2.5 mb-5 sm:mb-6 pb-4 sm:pb-5 border-b border-slate-100 flex-grow">
                  ...
                  {/* Assigned Technician */}
                  <div className="flex gap-2 text-xs sm:text-sm">
                    <span className="font-semibold text-slate-700 min-w-fit">Technician:</span>
                ...
                <div className="flex gap-2 items-stretch">
                  ...
                  <button
                    ...
                    className="px-3 sm:px-4 py-2 bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white font-bold rounded-lg transition-all duration-200 shadow-sm hover:shadow-md active:scale-95 text-xs sm:text-sm flex items-center gap-1.5 whitespace-nowrap"
                  >
